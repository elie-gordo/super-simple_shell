...
```sh
gcc -Wall -Wextra -Werror -pedantic 0-getppid.c -o ppid
gcc -Wall -Wextra -Werror -pedantic 0-av.c -o av
gcc -Wall -Wextra -Werror -pedantic 1-readline.c -o prompt
gcc -Wall -Wextra -Werror -pedantic 2-commandline.c -o split
gcc -Wall -Wextra -Werror -pedantic 3-fork_wait_execve_5.c -o run5
gcc -Wall -Wextra -Werror -pedantic 4-super_simple_shell.c -o shell
gcc -Wall -Wextra -Werror -pedantic 5-which_path.c -o _which
gcc -Wall -Wextra -Werror -pedantic 6-printenv_environ.c -o printenv_env
gcc -Wall -Wextra -Werror -pedantic 7-env_vs_environ.c -o env_addr
gcc -Wall -Wextra -Werror -pedantic 8-getenv_custom.c -o my_getenv
gcc -Wall -Wextra -Werror -pedantic 9-path_print_dirs.c -o path_dirs
gcc -Wall -Wextra -Werror -pedantic 10-path_linked_list.c -o path_list
gcc -Wall -Wextra -Werror -pedantic 11-setenv_custom.c -o my_setenv
gcc -Wall -Wextra -Werror -pedantic 12-unsetenv_custom.c -o my_unsetenv
```

Script:

```sh
chmod +x 1-pid_max.sh
./1-pid_max.sh
```
...
- pas d'arguments dans `4-super_simple_shell.c`
